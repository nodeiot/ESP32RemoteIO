...
const char page_network[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html>
    <style>
        .IndexBody {
    ...
    <body class="IndexBody">
        ...
        <div class="BoxShadow">
            ...
            <div class="FormBody">
                <form action="/submit-network" method="get">
...
const char page_account[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html>
    <style>
        .IndexBody {
    ...
    <body class="IndexBody">
        ...
        <div class="BoxShadow">
            ...
            <div class="FormBody">
                <form action="/submit-account" method="get">
                    <label for="ssid">Nome da rede Wi-Fi</label>
                    <input type="text" id="ssid" name="ssid">
                    <label for="password">Senha:</label>
                    <input type="text" id="password" name="password">
...
const char page_network_fail[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <script>
            setTimeout(function(){ window.location.href = '/network'; }, 8000);
        </script>
...
const char page_network_success[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <script>
            setTimeout(function(){ window.location.href = '/account'; }, 8000);
        </script>
        <div class="card-container">
            <div class="card">
                <div class="icon">✓</div>
                <div class="title">Rede Wi-Fi conectada.</div>
                <div class="message">Redirecionando para a página
                <br>de configurações da conta NodeIoT.<br/> </div>
            </div>
        </div>
    </body>
</html>
...
const char page_account_fail[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="card-container">
            <div class="card">
                <div class="icon">✓</div>
                <div class="title">Parâmetros ausentes. Tente novamente!</div>
                <div class="message">Redirecionando para a página
                <br>de conta NodeIoT.<br/> </div>
            </div>
        </div>
    </body>
</html>
...
const char page_account_success[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <script>
            setTimeout(function(){ window.location.href = '/monitor'; }, 8000);
        </script>
        <div class="card-container">
            <div class="card">
                <div class="icon">✓</div>
                <div class="title">Credenciais NodeIoT recebidas!</div>
                <div class="message">Redirecionando para a página
                <br>de monitoramento do dispositivo.<br/> </div>
            </div>
        </div>
    </body>
</html>
...
<html lang="pt-BR">
    ...
    <body class="IndexBody">
        ...
        <script>
            ...
            setTimeout(function(){ window.location.href = '/monitor'; }, 10000);
        </script>
    </body>
